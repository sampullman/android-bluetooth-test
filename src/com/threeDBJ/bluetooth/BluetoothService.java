...
import com.threeDBJ.bluetooth.BluetoothClient.BluetoothProfile;
...
public class BluetoothService {
    ...
    private class AcceptThread extends Thread {
	    ...
	    DebugLog.e(TAG, "Made it to run thread");
		    ...
		    DebugLog.e(TAG, "before connect");
                    socket = mmServerSocket.accept();
		    DebugLog.e(TAG, "after connect");
                } catch (IOException e) {
    ...
    private class ConnectedThread extends Thread {
	    ...
	    Bitmap bitmap;
			...
			send(client.getProfile());
			break;
		    case BluetoothClient.CLIENT_PROFILE:
			Object client = BluetoothProfile.build(mmInStream);
			handler.obtainMessage(cmd, -1, -1, client).sendToTarget();
			break;
		    default:
			DebugLog.e(TAG, "Error - invalid command received: "+cmd);
		    }
                } catch (IOException e) {
